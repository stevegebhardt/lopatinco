      ...
      <div>
          ...
          <div className="flex-row-center m-1">
            ...
            <div className="w-40 m-1">
              <p>
                ...
                Ontario after a 30 year hiyatus. The Windsor Raceway
                demonstrated the matchless effectiveness of two features that
                have since become trademarks of our work: energetic and precise
                financing and a heartfelt attention to detain.
              </p>
              <p>
                The raceway's physical plant - stables of a water resistant,
                light-weight, fiberglass-reinforces material never before used
                in race-course construction; glass-enclosed grand-stands and a
                club house to accommodate 3,100; and a specially designed,
                all-weather track of the new serface material, Tartan,
                engineered by 3M. All of these features have become standard
                design for similar projects throught the world.
              </p>
              <p>
          ...
          <div className="flex-row-center m-1">
            <div className="w-40 m-1">
              <p>
                ...
                Lawrence LoPatin raised $3.5 million and secured approvals for
                the development of nearly 800 acres in Lenawee County
              </p>
              <p>
                The track's combined 2-mile oval and road course, created
                especially for LoPatin by Charles Moneypenny and world champion
                race-car driver, Sterling Moss, received high praise from
                drivers, owners and fans. Race-driver celebrities Al and Bobby
                Unser called MIS the finest track in the country.
              </p>
              <p>
                And once again, innovation was key. LoPatin & Co.'s
                architechtural design called for a new kind of track that
                respected driver safety but still offered more excitement than
        ...
        <section className="w-100vw">
          <div className="flex-row-center m-1">
            ...
            <div className="w-40 m-1">
              <p>
                This project features two of the same type of buildings that
                total 250,000-square-feet of general office space and one
                freestanding restuarant.
              </p>
              <p>
                ...
                development team with the financial qualifications,
                environmental and aesthetic sensitivity to develop 16 acres of
                the school's surplus property in an innovative way.
              </p>
            </div>
          </div>
        </section>
